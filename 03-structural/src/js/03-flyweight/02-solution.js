console.log("02 flyweight -> solution");
var Task = function (data) {
    this.flyweight = FlayWeightFactory.get(data.project, data.priority, data.user, data.completed);
    this.name = data.name;
...
var FlayWeightFactory = function (){
    var flyweights = {};
...
console.log("tasks: " + FlayWeightFactory.getCount());